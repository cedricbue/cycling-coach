...
sealed class GarminException(message: String, cause: Throwable? = null) : RuntimeException(message, cause)

/** Credentials were rejected by Garmin SSO. Extends [IllegalArgumentException] for backward compatibility. */
class GarminAuthException(message: String) : IllegalArgumentException(message)
...
class GarminMfaRequiredException(message: String) : UnsupportedOperationException(message)
...
class GarminTokenException(message: String, cause: Throwable? = null) : GarminException(message, cause)
