        ...
        val samples =
            listOf(
                ...
                RidePowerSample(
                    ...
                    bestPower5min = null,
                    bestPower10min = null,
                    bestPower20min = 295.0,
                    bestPower60min = null,
                ),
            )
        // max 20min = 310 × 0.95 = 294.5 → 295
        assertThat(service.estimate(samples)).isCloseTo(
            295.0,
